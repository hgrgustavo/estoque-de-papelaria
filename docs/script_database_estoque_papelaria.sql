...
CREATE TABLE IF NOT EXISTS `cadastro_autores` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_cadastro_autores_cadastro_livros_idx` (`cadastro_livros_id` ASC) VISIBLE,
  CONSTRAINT `fk_cadastro_autores_cadastro_livros`
